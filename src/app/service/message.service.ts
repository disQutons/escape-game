...
export class MessageService {
  ...
  private hints: { [platform: string]: { [key: string]: string } } = {
    ...
    'generic': {
      ...
      'solution bulletin': 'La professeure principale est Madame Patel, reste à trouver son numéro.',
      ...
      '1 carte': 'De quelle carte parlez-vous ? De la carte d\'identité ? De tennis ? De transport ? De la ville ?',
      '2 carte': 'De quelle carte parlez-vous ? De la carte d\'identité ? De tennis ? De transport ? De la ville ?',
      'solution carte': 'De quelle carte parlez-vous ? De la carte d\'identité ? De tennis ? De transport ? De la ville ?',
      ...
      'solution discord': 'Le code pour accéder à Discord est le suivant : 51370365',
      ...
      'solution tennis': 'Le code pour accéder à Discord est le suivant : 51370365',
      ...
      'solution contrôle': 'Le code pour accéder à Discord est le suivant : 51370365',
      ...
      'solution math': 'Le code pour accéder à Discord est le suivant : 51370365',
      ...
      'solution emploi': 'La professeure principale est Madame Patel, reste à trouver son numéro.',
      ...
      'solution temps': 'La professeure principale est Madame Patel, reste à trouver son numéro.',
      ...
      'solution note': 'La professeure principale est Madame Patel, reste à trouver son numéro.',
      ...
      'solution interne': 'La professeure principale est Madame Patel, reste à trouver son numéro.',
